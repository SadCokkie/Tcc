    ...
    <div style="margin-left: 0; margin-right: 0; padding-left: 0;">
        <div id="layout-wrapper">
            ...
            <div class="main-content">
                ...
                <?= $this->include('iecg/avaliacoes/inscrever') ?>
    ...
    <script type="text/javascript">
        ...
        var anexar = function(id){
            ...
            $('#anexos').DataTable({
                ...
                createdRow: function (row, data, dataIndex) {
                    ...
                    botoes += ' <a  title="Baixar" href = "/Anexos/baixar/?nome='+data.Nome+'&origem=avaliacoes" class="meutooltip"><i class= "fas fa-file-download" ></i></a>';
        ...
        $(document).ready(function() {
            ...
            $('#datatable').DataTable({
                ...
                createdRow: function (row, data, dataIndex) {
                    $(row).attr('data-id', data.Cd_avaliacao);
                    var botoes = '<a href="/Avaliacoes/formulario/'+ data.Cd_avaliacao +'" title="Editar" class="meutooltip"><i class= "fas fa-edit" ></i></a>';
                    botoes += ' <a href="/Notas/?Cd_avaliacao='+ data.Cd_avaliacao +'" title="Notas" class="meutooltip"><i class= "fas fa-map-marker" ></i></a>';
                    botoes += ' <a onclick="remover('+ data.Cd_avaliacao +')" title="Remover" class="meutooltip"><i class= "fas fa-trash" ></i></a>';
                    botoes += ' <a onclick="anexar('+ data.Cd_avaliacao +')" title="Anexos" class="meutooltip"><i class= "fas fa-file-alt" ></i></a>';
                    $('td', row).eq(row.childElementCount-1).html(botoes);
                }
            });
