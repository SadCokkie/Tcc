                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row" style="margin-bottom: 30px;">
                                        <?= empresa('Aluno','empresa',11,$empresa) ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            filtrar = function () {
                ...
                $('#datatable').DataTable({
                    ajax: {
                        url: "/Relatorios/buscar_financeiro",
                        type: "post",
                        data: {empresa : $('#empresa').val()}
                    },
                    columns:[
                        { data: "Cd_contrato", orderable: false },
                        { data: "Cd_parcela", orderable: false },
                        { data: "Valor" , orderable: false},
                        { data: "Tipo", orderable: false },
                        { data: "Nome", orderable: false },
                        { data: "Data_pagamento" , orderable: false},
                        { data: "Validade", orderable: false },
                    ],
                    createdRow: function (row, data, dataIndex) {
                        $(row).attr('data-id', data.Cd_empresa + ' - ' + data.Nome_completo);
                    }
