                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Replace the default modifier classes with the <code class="highlighter-rouge">.btn-outline-*</code> ones to remove all
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">The <code class="highlighter-rouge">.btn</code> classes
                                    are designed to be used with the <code class="highlighter-rouge">&lt;button&gt;</code> element. However, you can
                                ...
                                <div class="button-items">
                                    <a class="btn btn-primary waves-effect waves-light" href="javascript: void(0);" role="button">Link</a>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Add <code class="highlighter-rouge">data-toggle="button"</code> to toggle a button’s
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-title-desc">Create block level buttons—those that span the full width
                                    of a parent—by adding <code class="highlighter-rouge">.d-grid</code>.</p>

                                <div class="d-grid gap-2">
                                    <button type="button" class="btn btn-primary btn-lg d-grid waves-effect waves-light mb-1">Block
                                        level button</button>
                                    <button type="button" class="btn btn-secondary btn-sm d-grid waves-effect waves-light">Block
                                        level button</button>
                                </div>
                            </div>
                        </div>
