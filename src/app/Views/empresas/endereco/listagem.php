                                    ...
                                    <div class="row" style="margin-bottom: 5px;">
                                        ...
                                        <div class="col-6">
                                            <div class="btn btn-group-sm width-xs right">
                                                <a style="margin-left: 5px;" class="btn btn-primary" title="Inserir" href="/Campos/formulario/?Cd_controle=<?= $Cd_controle ?>"><i class="fas fa-plus"></i></a>
                                                <a style="margin-left: 5px;" class="btn btn-secondary waves-effect waves-light right" title="Voltar" href="/Empresas/" role="button" ><i class="fas fa-reply"></i></a>
                                            </div>
                                        </div>
                                    </div>
